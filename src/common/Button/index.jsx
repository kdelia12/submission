...

  {
    ...
    variants: {
      ...
      variant: {
        ...
        primary: "bg-primary hover:bg-opacity-80 text-amber-500",
        secondary:
          "bg-secondary bg-opacity-10 text-black hover:bg-opacity-20 dark:text-amber-500 dark:bg-[rgb(255,255,255)] dark:bg-opacity-10 dark:hover:bg-opacity-20",
      },
