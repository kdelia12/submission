...
const featuresInfo = [
  {
    ...
    title: "HArdworking guys",
    desc: "Never stop building on the space",
  },
  {
    icon: (
      <svg
    ...
    desc: "Never stop learning before you die, because you will never know what you will get in the future.",
  },
  {
    icon: (
      <svg
    ...
    title: "Builder",
    desc: "I will never stop building on the space, because i love to build something new and make it useful for the community",
  },
];
...
`;
const FeatureTitle = tw.h4`mb-4 text-[1.563rem] font-bold  dark:text-amber-500`;

const MainFeatures = () => {
  return (
    <section className="main-features section-spacing bg-[#F9FAFF] dark:bg-black">
      <Container>
        ...
        >
          <h2 className="section-title mb-2 dark:text-amber-500">Who am i?</h2>

          <p>
            My name is Wildan Kamal Allam, a students, and social experimenter
          </p>
        </SectionTitleContainer>
